...
/// Controller for CloudVideoPlayer that allows external control.
class CloudVideoPlayerController extends ChangeNotifier {
  _CloudVideoPlayerState? _state;

  void _attach(_CloudVideoPlayerState state) {
    _state = state;
  }
...
/// A video player widget for displaying cloud-hosted videos.
/// Takes a signed URL and handles video playback with controls.
class CloudVideoPlayer extends StatefulWidget {
  final String url;
  final bool autoPlay;
  final CloudVideoPlayerController? controller;
