...
const (
	...
	ByteService_BulkStreamingUpload_FullMethodName = "/photos.ByteService/BulkStreamingUpload"
...
type ByteServiceClient interface {
	...
	BulkStreamingUpload(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[StreamingUploadRequest, BulkUploadFileResult], error)
...
func (c *byteServiceClient) BulkStreamingUpload(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[StreamingUploadRequest, BulkUploadFileResult], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &ByteService_ServiceDesc.Streams[1], ByteService_BulkStreamingUpload_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[StreamingUploadRequest, BulkUploadFileResult]{ClientStream: stream}
	return x, nil
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type ByteService_BulkStreamingUploadClient = grpc.BidiStreamingClient[StreamingUploadRequest, BulkUploadFileResult]
...
func (c *byteServiceClient) StreamingDownload(ctx context.Context, in *StreamingDownloadRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[StreamingDownloadResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &ByteService_ServiceDesc.Streams[2], ByteService_StreamingDownload_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
type ByteServiceServer interface {
	...
	// A BulkUploadFileResult is streamed back for each file as it completes,
	// without waiting for all files in the batch to finish.
	BulkStreamingUpload(grpc.BidiStreamingServer[StreamingUploadRequest, BulkUploadFileResult]) error
	// StreamingDownload downloads a photo using server-side streaming for large files
...
func (UnimplementedByteServiceServer) BulkStreamingUpload(grpc.BidiStreamingServer[StreamingUploadRequest, BulkUploadFileResult]) error {
	return status.Error(codes.Unimplemented, "method BulkStreamingUpload not implemented")
}
...
func _ByteService_BulkStreamingUpload_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(ByteServiceServer).BulkStreamingUpload(&grpc.GenericServerStream[StreamingUploadRequest, BulkUploadFileResult]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type ByteService_BulkStreamingUploadServer = grpc.BidiStreamingServer[StreamingUploadRequest, BulkUploadFileResult]
...
var ByteService_ServiceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "BulkStreamingUpload",
			Handler:       _ByteService_BulkStreamingUpload_Handler,
			ServerStreams: true,
			ClientStreams: true,
		},
		{
...
func (c *libraryServiceClient) GenerateVideoThumbnail(ctx context.Context, in *GenerateVideoThumbnailRequest, opts ...grpc.CallOption) (*GenerateVideoThumbnailResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GenerateVideoThumbnailResponse)
	err := c.cc.Invoke(ctx, LibraryService_GenerateVideoThumbnail_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _LibraryService_GenerateVideoThumbnail_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GenerateVideoThumbnailRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(LibraryServiceServer).GenerateVideoThumbnail(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: LibraryService_GenerateVideoThumbnail_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LibraryServiceServer).GenerateVideoThumbnail(ctx, req.(*GenerateVideoThumbnailRequest))
	}
	return interceptor(ctx, in, info, handler)
}
